    ...
    public partial class Help : Form
    {
        ...
        private void Help_Load(object sender, EventArgs e)
        {
            lblHuongDan.Text = "+ Chương trình thực hiện các chức năng: Thêm, Sửa, Xóa trên bộ dữ liệu"
                                ...
                                + "\n+ Đối với giá trị ngày tháng, vì mặc định bộ dữ liệu liên tục nên sẽ không cần phải Training dữ liệu"
                                + "\n+ Ngược lại các giá trị khác sẽ cần thực hiện Training theo hướng dẫn"
                                + "\n+ Sau khi nhấn Decision Tree Using Rough Set Theory, chúng ta có thể xem quá trình Training"
